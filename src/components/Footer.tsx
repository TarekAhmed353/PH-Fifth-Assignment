      ...
      <div className="mx-auto max-w-7xl px-4 py-14">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm text-base-content/70">
              Curated tools, technologies, and resources for developers building modern software.
            </p>
            <div className="mt-6 flex gap-5 text-sm font-medium">
              {socialLinks.map((social) => (
                <a key={social.name} href={social.href} target="_blank" rel="noreferrer" className="text-base-content/70 transition-colors hover:text-pink-600">
                  {social.name}
                </a>
              ))}
            </div>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-base-200 pt-6 text-sm text-base-content/60 sm:flex-row sm:items-center sm:justify-between">
